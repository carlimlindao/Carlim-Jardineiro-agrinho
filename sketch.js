...
function draw() {
  ...
  let corFundo = lerpColor(color(50, 12, 26), color(30, 239, 100),
...
function mostrarInformacoes() {
  textSize(26);
  fill(0);
  text("Plante árvores comigo!",10, 30)
  textSize(14);
  fill('white');
...
function mostrarMensagemDeVitoria() {
  textSize(20);
  fill(0, 0, 0);
  text("🎉boaaaa!!!! vc ganhouu finalmente já estava na hora", 100, 200);
  noLoop();
}
...
function mostrarMensagemDeDerrota() {
  textSize(20);
  fill(0, 0, 0);
  text("😒 vc precisar tentar mais, bicho. Aqui tá muito quente!", 100, 200);
  noLoop();
}
